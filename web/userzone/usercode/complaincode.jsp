...
<%
    ...
    {
    out.print("<script>alert('Complaint is registered');window.location.href='../complain.jsp';</script>");
    }
    else
    {
    out.print("<script>alert('Complaint is not registered');window.location.href='../complain.jsp';</script>");
    }
%>